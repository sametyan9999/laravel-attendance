<header class="gt-header">
    <div class="gt-header__inner">
        ...
        <a href="{{ url('/') }}" class="gt-logo" aria-label="COACHTECH">
            <img
                src="{{ asset('images/COACHTECHlogo.png') }}"
                alt="COACHTECH"
            ...
            @else
                ...
                @can('admin')
                    <nav class="gt-nav" aria-label="グローバル">
                        <a href="{{ route('admin.attendance.list') }}" class="gt-nav__link">勤怠一覧</a>
                        <a href="{{ route('admin.staff.index') }}" class="gt-nav__link">スタッフ一覧</a>
                        <a href="{{ route('admin.request.index') }}" class="gt-nav__link">申請一覧</a>
